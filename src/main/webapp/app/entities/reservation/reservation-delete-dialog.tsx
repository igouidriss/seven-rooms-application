...
export const ReservationDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="sevenRoomsToHubApplicationApp.reservation.delete.question">
        <Translate contentKey="sevenRoomsToHubApplicationApp.reservation.delete.question" interpolate={{ id: reservationEntity.id }}>
