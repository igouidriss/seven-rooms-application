...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLIENTPHOTO_LIST actions', async () => {
    ...
    it('dispatches FETCH_CLIENTPHOTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CLIENTPHOTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CLIENTPHOTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CLIENTPHOTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CLIENTPHOTO actions', async () => {
      const expectedActions = [
        {
