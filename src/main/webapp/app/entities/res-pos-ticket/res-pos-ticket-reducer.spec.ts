...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RESPOSTICKET_LIST actions', async () => {
    ...
    it('dispatches FETCH_RESPOSTICKET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RESPOSTICKET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RESPOSTICKET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RESPOSTICKET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RESPOSTICKET actions', async () => {
      const expectedActions = [
        {
