...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RESCUSTOMFIELD_LIST actions', async () => {
    ...
    it('dispatches FETCH_RESCUSTOMFIELD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RESCUSTOMFIELD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RESCUSTOMFIELD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RESCUSTOMFIELD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RESCUSTOMFIELD actions', async () => {
      const expectedActions = [
        {
