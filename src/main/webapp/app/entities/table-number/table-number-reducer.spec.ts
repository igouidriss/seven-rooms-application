...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TABLENUMBER_LIST actions', async () => {
    ...
    it('dispatches FETCH_TABLENUMBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TABLENUMBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TABLENUMBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TABLENUMBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TABLENUMBER actions', async () => {
      const expectedActions = [
        {
