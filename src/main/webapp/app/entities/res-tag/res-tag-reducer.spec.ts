...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './res-tag.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RESTAG_LIST actions', async () => {
    ...
    it('dispatches FETCH_RESTAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RESTAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RESTAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RESTAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RESTAG actions', async () => {
      const expectedActions = [
        {
