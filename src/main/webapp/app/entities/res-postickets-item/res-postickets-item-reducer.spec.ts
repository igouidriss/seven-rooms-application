...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './res-postickets-item.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RESPOSTICKETSITEM_LIST actions', async () => {
    ...
    it('dispatches FETCH_RESPOSTICKETSITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RESPOSTICKETSITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RESPOSTICKETSITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RESPOSTICKETSITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RESPOSTICKETSITEM actions', async () => {
      const expectedActions = [
        {
