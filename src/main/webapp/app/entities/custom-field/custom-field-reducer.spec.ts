...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CUSTOMFIELD_LIST actions', async () => {
    ...
    it('dispatches FETCH_CUSTOMFIELD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CUSTOMFIELD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CUSTOMFIELD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CUSTOMFIELD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CUSTOMFIELD actions', async () => {
      const expectedActions = [
        {
