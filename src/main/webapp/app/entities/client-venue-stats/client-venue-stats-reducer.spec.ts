...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './client-venue-stats.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLIENTVENUESTATS_LIST actions', async () => {
    ...
    it('dispatches FETCH_CLIENTVENUESTATS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CLIENTVENUESTATS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CLIENTVENUESTATS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CLIENTVENUESTATS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CLIENTVENUESTATS actions', async () => {
      const expectedActions = [
        {
