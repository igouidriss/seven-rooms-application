...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLIENTTAG_LIST actions', async () => {
    ...
    it('dispatches FETCH_CLIENTTAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CLIENTTAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CLIENTTAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CLIENTTAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CLIENTTAG actions', async () => {
      const expectedActions = [
        {
